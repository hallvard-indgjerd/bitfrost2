...
--
-- Table structure for table `list_user_role`
--
...
--
-- Dumping data for table `list_user_role`
--

LOCK TABLES `list_user_role` WRITE;
/*!40000 ALTER TABLE `list_user_role` DISABLE KEYS */;
INSERT INTO `list_user_role` VALUES (1,'Administrator','Administratör'),(5,'Author','Author'),(3,'Editor','Editor'),(6,'Researcher','Researcher'),(4,'Reviewer','Reviewer'),(2,'Supervisor','Supervisor');
...
-- Dump completed on 2023-05-08 10:56:04
